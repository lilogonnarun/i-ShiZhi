...
Page({
  ...
  gotoDetail(e) {
    ...
    /*将空图片替换 */
    if (detail.img1 == null) {
      detail.img1 = '/images/pic1.jpg'
    }
    if (detail.img2 == null) {
      detail.img2 = '/images/pic1.jpg'
    }
    if (detail.img3 == null) {
      detail.img3 = '/images/pic1.jpg'
    }
    if (detail.img4 == null) {
      detail.img4 = '/images/pic1.jpg'
    }
    if (detail.img5 == null) {
      detail.img5 = '/images/pic1.jpg'
    }
    if (detail.img6 == null) {
      detail.img6 = '/images/pic1.jpg'
    }
    if (detail.img7 == null) {
      detail.img7 = '/images/pic1.jpg'
    }
    if (detail.img8 == null) {
      detail.img8 = '/images/pic1.jpg'
    }
    if (detail.img9 == null) {
      detail.img9 = '/images/pic1.jpg'
    }
    /*编码，避免读取失败*/
